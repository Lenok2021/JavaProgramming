...
public class ArrayOfMap {
    ...
    public static void main(String[] args) {
        ...
        for (Map<String, String> eachMap : array) {

            for (Map.Entry<String, String> eachPair : eachMap.entrySet()) {
                String eachName = eachPair.getKey();
                String eachMember = eachPair.getValue();
                //  Print the names of all Developers
                if (eachMember.equals("SM")) {
                    System.out.println("eachName = " + eachName);
                }
                // Print the names of all Developers
                if (eachMember.equals("Developer")) {
                    System.out.println("eachName = " + eachName);
                }
