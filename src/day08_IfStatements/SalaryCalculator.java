...
public class SalaryCalculator {
    ...
    public static void main(String[] args) {
        ...
        int salaryBeforeTax = hourlyRate * weeklyHours * 52; // salary one week = per/our * weekly hours
        double stateTax = salaryBeforeTax * stateTaxRate / 100;// if you want to convert % to decimal number / 100
